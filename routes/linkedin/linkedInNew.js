...
const proxyClientId = process.env.LINKEDIN_PROXY_CLIENT_ID;
const proxyIdpId = process.env.LINKEDIN_PROXY_IDP_ID;
...
//   console.log("res>>",res.req.user.emails[0].value);
  ...
  createIdToken(proxyClientId, user, { signingAlg: 'RS256', rsaPrivateKey, keyId })
    .then(idpToken => {
      const userInfo = {
