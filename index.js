...
const localHostBackendURL = process.env.PROD_APP_BACKEND_URL;
...
var slider = require("./routes/api/slider")
var intro = require("./routes/api/intro")
var session1 = require("./routes/api/session1")
var blog = require("./routes/api/blog")
var blogname = require("./routes/api/blogname")
var bloglist = require("./routes/api/bloglist")
var testimonial = require("./routes/api/testimonial")
var testimoniallist = require("./routes/api/testimoniallist")
var step = require("./routes/api/step")

app.use("/slider", slider)
app.use("/intro", intro)
app.use("/blog", blog)
app.use("/session1", session1)
app.use("/blogname", blogname)
app.use("/bloglist", bloglist)
app.use("/testimonial", testimonial)
app.use("/testimoniallist", testimoniallist)
app.use("/step", step)
